...
RUN rm -f hdbscan-jar_5.1.2_amd64.deb hdbscan-java_5.1.2_amd64.deb hdbscan-lib_5.1.2_amd64.deb hdbscan-python_5.1.2_amd64.deb

ARG JAR_FILE=target/*.jar
COPY ${JAR_FILE} hdbscan-rest.jar
ENTRYPOINT ["java","-jar","/app/hdbscan-rest.jar"]